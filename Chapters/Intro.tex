...
At a more personal level, and as a computer science student, my major interest has always been software engineering, and even after completing the first year of a master's degree in a more advanced subject, 
...
client-server model for the existing Autopsy platform, or (2) the adaptation of the existing Autopsy platform for macOS \cite{macos} environments; The chosen proposal was the former as it 
seemed to be the most challenging and also the most useful option.
