...
\begin{figure}[ht]
 \centering
 \includegraphics[width=1\linewidth]{imgs/reports.png}
...
For the publication of the Platform as Open Source, a static presentation website was created, containing the following pages:
...
For this, an open source publication should allow installations of the platform and a feedback channel to better understand the user's needs.
