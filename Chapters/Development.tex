...
Firstly the default modules included with Autopsy were adapted, these modules are either file ingest modules, which analyse each file contained in a data source, one by one,
