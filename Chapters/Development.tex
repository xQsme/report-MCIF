...
This challenge is transmited to the client, and then transmited to the \acrshort{u2f} device, which then generates the response which is used to validate the challenge.
