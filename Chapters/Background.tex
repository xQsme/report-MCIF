...
In this chapter, a contextualization of digital forensics is given, an analysis of both \citetitle{sleuthkit} (TSK) \cite{sleuthkit} and Autopsy is made, and it's given a brief description and analysis of the existing forensic platform alternatives.
...
Digital forensics, according to \citeauthor{nist2} \cite{nist2}, is the field of forensic science that is concerned with retrieving,
...
The Sleuth Kit is a library and collection of command line tools that allow the
...
\citetitle{ftk} (FTK) \cite{ftk} is an award-winning, court-cited digital investigations solution. 
...
FTK allows users to create images, process a wide range of data types, analyze the registry, crack passwords, and build reports. 
