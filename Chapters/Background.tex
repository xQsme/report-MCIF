...
In this chapter, a contextualization of digital forensics is given, an analysis of both \citetitle{sleuthkit} (TSK) \cite{sleuthkit} and \citetitle{autopsy} \cite{autopsy} is made, it's given a brief description of
...
Any of these software options seem viable for any kind of digital forensics investigation, and as a digital forensics firm, the teams should first test all these available options and chose the one that best suits their needs.
