...
\documentclass[ twoside,openright,titlepage,numbers=noenddot,headinclude,%1headlines,% letterpaper a4paper
                footinclude=false,cleardoublepage=plain,abstractoff, % <--- obsolete, remove (todo)
...
\newcommand{\myDegreeEn}{Master in Cybersecurity and Digital Forensics\xspace}
...
\newcommand{\myFacultyEn}{Polytechnic of Leiria\xspace}
\newcommand{\mySchoolEn}{Escola Superior de Tecnologia e Gestão\xspace}
\newcommand{\myDepartmentEn}{Computer Engineering Department\xspace}
\newcommand{\myLocation}{Leiria\xspace}

\newcommand{\myTime}{15 de Julho de 2020\xspace}
\newcommand{\myTimeEn}{July 15th, 2020\xspace}
